...
class LIBSUNet(nn.Module):
    ...
    def __init__(self, max_z, l_spec):
        ...
        self.up_trans_4 = nn.ConvTranspose1d(
            ...
            kernel_size=2,
            stride=2)
        self.up_conv_4 = double_conv(2*chan, 1) # drop down to single channel with many features
        self.final = nn.Linear(796,80) #map the many features to elemental fractions
